    ...
    <form class="layui-form" action="">
        <div class="layui-form-item">
            <div class="layui-inline tool-btn">
                <a href="<?=\yii\helpers\Url::to(['user/backend-user-add'])?>" class="layui-btn layui-btn-small layui-btn-normal addBtn hidden-xs"><i class="layui-icon">&#xe654;</i></a>
        ...
        <table class="layui-table" lay-even lay-skin="nob">
            ...
            <?php foreach ($user as $u){?>
                <tr>
                    ...
                    <td>
                        <div class="layui-inline">
                            <a href="<?=\yii\helpers\Url::to(['user/backend-user-add','id'=>$u['id']])?>" class="layui-btn layui-btn-mini layui-btn-normal  edit-btn" data-id="1"><i class="layui-icon">&#xe642;</i></a>
                            <a href="<?=\yii\helpers\Url::to(['user/user-del','id'=>$u['id']])?>" class="layui-btn layui-btn-mini layui-btn-danger del-btn" data-id="1" ><i class="layui-icon">&#xe640;</i></a>
                        </div>
                    </td>
                </tr>
            <?php }?>
